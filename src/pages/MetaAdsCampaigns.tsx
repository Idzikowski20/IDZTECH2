  ...
  return <div className="min-h-screen bg-premium-dark">
            ...
            animationDelay: '0.4s'
              ...
              <div className="relative">
                ...
                <div className="relative bg-premium-dark p-1 rounded-xl overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80" alt="Meta Ads Campaign" className="w-full h-auto rounded-lg object-cover aspect-video" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in" style={{
          animationDelay: '0.5s'
        }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-premium-dark/60 border border-white/10 rounded-xl p-6 transition-transform hover:-translate-y-2 duration-300 animate-fade-in" style={{
            animationDelay: '0.6s'
          }}>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-8">
            ...
            delay: "0.9s"
          }].map((item, index) => <div key={index} className="flex flex-col md:flex-row items-start gap-6 animate-fade-in" style={{
          ...
          animationDelay: '0.6s'
            ...
            <div className="bg-premium-dark/60 border border-white/10 rounded-xl p-8">
              <div className="space-y-6">
                {["Ogromny zasięg - możliwość dotarcia do ponad 3 miliardów użytkowników platformy Meta", "Zaawansowane targetowanie - precyzyjne definiowanie grupy odbiorców", "Różnorodne formaty reklamowe - teksty, zdjęcia, wideo, karuzele, kolekcje", "Budowanie społeczności wokół marki i długotrwałych relacji z klientami", "Możliwość śledzenia i analizowania wyników kampanii w czasie rzeczywistym", "Niższy koszt pozyskania klienta w porównaniu do tradycyjnych kanałów marketingowych"].map((item, index) => <div key={index} className="flex items-start">
            ...
            <div className="relative">
              <div className="absolute -inset-1 rounded-xl blur-sm opacity-75"></div>
              <div className="relative bg-premium-dark p-1 rounded-xl overflow-hidden">
                <img src="https://images.unsplash.com/photo-1579869847514-7c1a19d2d2ad?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1734&q=80" alt="Meta Ads Benefits" className="w-full h-auto rounded-lg object-cover aspect-video" />
              </div>
            </div>
          </div>
        </div>
