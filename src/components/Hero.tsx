    ...
    <section id="hero" className="pt-24 pb-32 md:pt-32 md:pb-44 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div
            className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10 animate-fade-in opacity-0"
          ...
          <div
            className="flex flex-col md:flex-row gap-4 md:gap-8 justify-center text-sm text-premium-light/70 animate-fade-in opacity-0"
