    ...
    <section id="contact" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-premium-purple font-medium">Kontakt</span>
          <h2 className="text-3xl lg:text-4xl font-bold mt-3 mb-6">Skontaktuj się z nami</h2>
            ...
            <div className="bg-premium-dark/60 backdrop-blur-sm border border-white/10 rounded-xl p-6 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-lg bg-premium-gradient flex items-center justify-center mr-4 flex-shrink-0">
                    <MapPin size={20} className="text-premium-light" />
                  </div>
                  <div>
                    <h4 className="font-medium mb-1">Adres</h4>
                    <p className="text-premium-light/70 text-sm">ul. Przykładowa 123, 00-000 Warszawa</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-lg bg-premium-gradient flex items-center justify-center mr-4 flex-shrink-0">
                    <Phone size={20} className="text-premium-light" />
                  </div>
                  <div>
                    <h4 className="font-medium mb-1">Telefon</h4>
                    <p className="text-premium-light/70 text-sm">+48 123 456 789</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-lg bg-premium-gradient flex items-center justify-center mr-4 flex-shrink-0">
                    <Mail size={20} className="text-premium-light" />
                  </div>
                  <div>
                    <h4 className="font-medium mb-1">Email</h4>
                    <p className="text-premium-light/70 text-sm">kontakt@premiumdigital.pl</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-lg bg-premium-gradient flex items-center justify-center mr-4 flex-shrink-0">
                    <Clock size={20} className="text-premium-light" />
                  </div>
                  <div>
                    <h4 className="font-medium mb-1">Godziny pracy</h4>
                    <p className="text-premium-light/70 text-sm">Poniedziałek - Piątek: 9:00 - 17:00</p>
                  </div>
                </div>
              </div>
              
              <div className="mt-8">
                <h4 className="font-medium mb-3">Znajdź nas</h4>
