  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div className="absolute bottom-10 left-10 w-80 h-80 bg-premium-blue/20 rounded-full blur-[100px]"></div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="w-full lg:w-1/2 space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button className="border-gray-200 hover:opacity-90 transition-opacity text-white rounded-full px-8 py-6">
                Poznaj nasze usługi
                <ArrowRight size={18} className="ml-2" />
              </Button>
            </div>
